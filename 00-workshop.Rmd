...
- They had five days to sinke the Titanic.
- We only have 3 hours.
- We are on a three hour tour!
...
- Captain Smith says YOU need write code.
    - He ~~*does* have a good track record~~. He sank his boat.
...
- Shoulder Surfers to the rescue!
- Stop me if you feel you are getting lost.
...
- SAS was developed at the North Carolina State University
  ...
  relationship with healthcare, it was originally developed to analyze
  agricultural data.
...
- The aim of the language is: "to turn ideas into software, quickly
  and faithfully".
- R is an open source descendent of S
...
- [Data Carpentry's R Ecology Demo](http://www.datacarpentry.org/)

TODO - Table with logos~
