...
```{r init, echo=FALSE, results="none", message=FALSE}
...
- I dunno. What the hell are we doing here?
...
- Somehow, two people scored worse than I did. Impressive.

</div>

# Is This Model Useful?

<img src="img/captain-smith.jpg" width=25%>
...
- This model bumped us up 36 positions on the leaderboard.
- We are now sitting in position 2,295.
